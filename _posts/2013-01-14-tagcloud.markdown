...
### Updated on January the 20th, 2003: Scroll to the end of the page!
...
* The tag cloud is now generated once for every page: you can close the popup window, go to other pages, and highlighting and selections will be kept.
